...
- GitHub Pages: <https://falo-taiwan.github.io/ai-notebooklm/v1/index.html>
- Refactor Notes: <https://falo-taiwan.github.io/ai-notebooklm/v1/docs/refactor_notes.html>
- Command Package Example: <https://falo-taiwan.github.io/ai-notebooklm/v1/examples/sample_command_package_upload_folder.json>
...
- `v1/index.html`：GitHub Pages 用的單檔專案簡介。
- `v1/docs/refactor_notes.md`：架構與改版筆記。
- `v1/docs/refactor_notes.html`：人看的 HTML 版筆記。
- `v1/examples/sample_command_package_upload_folder.json`：去識別化指令包範例。
